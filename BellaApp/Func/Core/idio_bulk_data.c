...
bool idioBulkDataIsEnabled(void) { return false; }


void idioBulkDataInit(void) {}
void idioBulkDataService(void) {}
void idioBulkDataServiceEnable(uint8_t enable) {UNUSED(enable);}
//uint8_t idioBulkDataHandler(AID_CMD_Type * idioCommandPacketPtr, AID_RESP_Type * idioResponsePacketPtr) {UNUSED(idioCommandPacketPtr);UNUSED(idioResponsePacketPtr);}
...
//  while (hidEndpoints--) {
//    idioEndpointConfig[idioEndpointCount++] = AID_ENDPOINT_FUNCTION_HID;
//  }
//#endif
//#ifdef CNFG_AID_HAS_BULK_DATA_DEVICE_CTL
...
//
//#ifdef CNFG_AID_HAS_BULK_DATA_DEVICE_CTL
//  if (!dataFlag && epDeviceControlGetAsyncDataPendingFlag()) {
//    dataFlag = true;
//  }
//#endif
//
//#ifdef CNFG_AID_HAS_BULK_DATA_HID
//  if (!dataFlag && epHIDGetAsyncDataPendingFlag()) {
//    dataFlag = true;
//  }
//#endif
//
//#ifdef CNFG_AID_HAS_IAP2
//  if (!dataFlag && epIAPGetAsyncDataPendingFlag()) {
//    dataFlag = true;
//  }
//#endif  // CNFG_AID_HAS_IAP2
//
//#ifdef CNFG_AID_HAS_BULK_DATA_PD
//  if (!dataFlag && epPDGetAsyncDataPendingFlag()) {
//    dataFlag = true;
//  }
...
//        idioResponsePacketPtr->packet.buffer[AID_RESP_BULK_DATA_PAYLOAD_OFFSET + i] = CNFG_AID_BULK_DATA_PAD_DATA;
//
...
//  }
//
//  if (1) { //idioBulkDataReadEndpointResponsePacket.packetProcessFlag == false) {
