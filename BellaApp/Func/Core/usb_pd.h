...
#define PDO_V5V3A_SRC         (USB_PDO_TYPE_FIXED | USB_PDO_VOLTAGE(5000) |USB_PDO_CURRENT(3000) )
#define PDO_V5V1A_SRC         (USB_PDO_TYPE_FIXED | USB_PDO_VOLTAGE(5000) |USB_PDO_CURRENT(1000) )
#define PDO_V9V3A_SRC         (USB_PDO_TYPE_FIXED | USB_PDO_VOLTAGE(9000) |USB_PDO_CURRENT(3000) )
#define PDO_V15V3A_SRC        (USB_PDO_TYPE_FIXED | USB_PDO_VOLTAGE(15000) |USB_PDO_CURRENT(3000) )
#define PDO_V20V3A_SRC        (USB_PDO_TYPE_FIXED | USB_PDO_VOLTAGE(20000) |USB_PDO_CURRENT(3000) )
