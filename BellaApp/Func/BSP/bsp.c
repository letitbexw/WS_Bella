...
static void gpioInit(void)
{
	...
	initGPIO(GPIOA, GPIO_PIN_7,  GPIO_MODE_INPUT, GPIO_NOPULL, 0, 0);	// PA7
	initGPIO(GPIOB, GPIO_PIN_4,  GPIO_MODE_INPUT, GPIO_NOPULL, 0, 0);	// PB4
	initGPIO(GPIOB, GPIO_PIN_12, GPIO_MODE_INPUT, GPIO_NOPULL, 0, 0);	// PB12
	initGPIO(GPIOD, GPIO_PIN_0,  GPIO_MODE_INPUT, GPIO_NOPULL, 0, 0);	// PD0
	initGPIO(GPIOD, GPIO_PIN_1,  GPIO_MODE_INPUT, GPIO_NOPULL, 0, 0);	// PD1
	initGPIO(GPIOD, GPIO_PIN_2,  GPIO_MODE_INPUT, GPIO_NOPULL, 0, 0);	// PD2
	initGPIO(GPIOD, GPIO_PIN_3,  GPIO_MODE_INPUT, GPIO_NOPULL, 0, 0);	// PD3
}
