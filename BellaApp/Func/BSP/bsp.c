...
static void gpioInit(void)
{
	...
	initGPIO(AID_PU_EN_L, 		GPIO_MODE_OUTPUT_PP, GPIO_NOPULL,	GPIO_PIN_SET, 0);	/* PF0, AID_PU_EN_L */
	initGPIO(AID_PD_EN, 		GPIO_MODE_OUTPUT_PP, GPIO_NOPULL,	GPIO_PIN_SET, 0);	/* PF1, AID_PD_EN */
	...
	initGPIO(GPIOA, GPIO_PIN_7,  GPIO_MODE_INPUT, GPIO_NOPULL, 0, 0);	// PA7		- 2. ORION_DATA_GATED, 	R88
	initGPIO(GPIOB, GPIO_PIN_4,  GPIO_MODE_INPUT, GPIO_NOPULL, 0, 0);	// PB4		- 1. ORION_DATA
	initGPIO(GPIOB, GPIO_PIN_12, GPIO_MODE_INPUT, GPIO_NOPULL, 0, 0);	// PB12		- 6. AID_PD_EN, 		R73
	initGPIO(GPIOD, GPIO_PIN_0,  GPIO_MODE_INPUT, GPIO_NOPULL, 0, 0);	// PD0		- 7. AID_PU_EN_L, 		R71
	initGPIO(GPIOD, GPIO_PIN_1,  GPIO_MODE_INPUT, GPIO_NOPULL, 0, 0);	// PD1		- 5. DATA_ENABLE, 		R61
	initGPIO(GPIOD, GPIO_PIN_2,  GPIO_MODE_INPUT, GPIO_NOPULL, 0, 0);	// PD2		- 4. RX_COMP_OUT, 		R60/R87
	initGPIO(GPIOD, GPIO_PIN_3,  GPIO_MODE_INPUT, GPIO_NOPULL, 0, 0);	// PD3		- 3. TX_FROM_MCU, 		R96
}
